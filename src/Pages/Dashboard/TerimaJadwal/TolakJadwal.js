      ...
      <View>
        <View
          ...
          <View style={{marginHorizontal: 10, marginTop: -25}}>
            <Text style={styles.header}>Jadwal Berhasil Kamu Tolak</Text>
            <Text style={styles.text}>
              Jadwal setor mitra warga kamu, sudah berhasil kamu tolak. Harap
              memberikan alasan saat menolak jadwal
            </Text>
          </View>
        </View>
      </View>
